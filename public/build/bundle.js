...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			p = element("p");
    			p.textContent = "Loading transmorglyphs...";
    			attr_dev(p, "class", "svelte-1dhi3vj");
    			add_location(p, file$6, 57, 6, 1745);
    			attr_dev(div, "class", "loading svelte-1dhi3vj");
    			add_location(div, file$6, 56, 4, 1716);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    ...
    function create_if_block$1(ctx) {
    	...
    	let strong;
    	let t6;
    	let t7_value = /*getEventText*/ ctx[2]() + "";
    	let t7;
    	let p1_transition;
    	let div_transition;
    	let current;
    	let if_block = /*showOverlay*/ ctx[1] && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			t7 = text(t7_value);
    			attr_dev(h1, "class", "svelte-1dhi3vj");
    			add_location(h1, file$6, 40, 6, 1187);
    			attr_dev(p0, "class", "tagline svelte-1dhi3vj");
    			add_location(p0, file$6, 47, 6, 1405);
    			add_location(strong, file$6, 51, 8, 1621);
    			attr_dev(p1, "class", "promo svelte-1dhi3vj");
    			add_location(p1, file$6, 50, 6, 1544);
    			attr_dev(div, "class", "background background-image svelte-1dhi3vj");
    			add_location(div, file$6, 36, 4, 1082);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h1);
    		...
    		p: function update(ctx, dirty) {
    			if (/*showOverlay*/ ctx[1]) {
    				if (if_block) {
    					if (dirty & /*showOverlay*/ 2) {
    						transition_in(if_block, 1);
    					}
    				} else {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "overlay background-image svelte-1dhi3vj");
    			add_location(div, file$6, 42, 8, 1276);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			current = true;
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!div_transition) div_transition = create_bidirectional_transition(div, fade, { duration: 2000 }, true);
    				div_transition.run(1);
    			});
    		...
    		o: function outro(local) {
    			if (!div_transition) div_transition = create_bidirectional_transition(div, fade, { duration: 2000 }, false);
    			div_transition.run(0);
    			current = false;
    		},
    		d: function destroy(detaching) {
    ...
    // (35:0) <Splash backgroundColor="#191B1A">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(35:0) <Splash backgroundColor=\\\"#191B1A\\\">",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, showOverlay, show*/ 19) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	const getEventText = () => {
    		...
    		return `${date.getFullYear()}-${(date.getMonth() + 1).toString().padStart(2, "0")}-${date.getDate().toString().padStart(2, "0")} ${text}`;
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("showOverlay" in $$props) $$invalidate(1, showOverlay = $$props.showOverlay);
    	...
    	return [show, showOverlay, getEventText];
    }
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t0 = text("Frontend developer and story writer. Responsible for a large portion of\r\n      the rooms and has been with the project from the start. The teams biggest\r\n      ");
    			a = element("a");
